...
class MCLEA:
    ...
    def init_data(self):
        ...
        self.ocr_features,ocrornot =load_ocr_features(self.ENT_NUM, file_dir)
        self.ocr_features = F.normalize(
            torch.Tensor(self.ocr_features).to(device))
        print("ocr feature shape:", self.ocr_features.shape) #[ent_num,2048] 
    ...
    def init_model(self):
        ...
        self.multimodal_encoder = AllMultiModalEncoder(args=self.args,
